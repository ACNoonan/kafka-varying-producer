class Order:
    def __init__(self, id, user_id, total, status, address_id, payment_id, created_at, modified_at):
        self.id = id
    ...
    def __str__(self):
        return (
            ...
            f"status={self.status}, address_id={self.address_id}, payment_id={self.payment_id}, "
